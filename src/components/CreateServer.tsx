...
export const CreateServer = ({ theme, onServerCreated }: CreateServerProps) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-[#0B0E11] p-12 text-center">
      ...
      <h2 className="text-4xl font-black text-white mb-4">Yeni Bir Dünya Kur</h2>
      <p className="text-white/40 mb-12 max-w-sm">Kendi topluluğunu oluştur, arkadaşlarını davet et ve ekosistemi birlikte büyütün.</p>
      
      <div className="w-full max-w-md space-y-6">
        <div className="text-left">
          <label className="text-[10px] font-bold text-white/40 uppercase tracking-widest block mb-2 ml-2">Sunucu Adı</label>
          <input 
            value={name} 
