    ...
    <div className="flex-1 flex flex-col bg-[#0B0E11] overflow-hidden">
      <header className="h-14 border-b border-white/5 flex items-center px-6 justify-between bg-black/20 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-white uppercase tracking-widest text-sm">Sunucu Keşfet</h3>
        </div>
      ...
      <div className="flex-1 p-12 overflow-y-auto custom-scrollbar">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl font-black text-white mb-2">Popüler Topluluklar</h2>
            <p className="text-white/40 text-sm">Ekosistemin en aktif ve büyüyen sunucularına katıl.</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-[10px] font-bold text-white/20 uppercase tracking-widest mb-6">{s.members} Üye</p>
                <button 
                  onClick={onJoin} 
